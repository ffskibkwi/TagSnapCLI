...
from analysis import build_model, segment_text
...
def run(temperature: float = typer.Option(0.3, help="生成温度(0-1)")):
    ...
    def on_submit(text: str):
        return segment_text(model, text, temperature=temperature)
